    ...
    Parser.prototype.tok = function() {
      switch (this.token.type) {
        ...
        */
         ...
         */
        function editingPage (element, destinationElement, lightning) {
          console.log(element);
          ...
          if(!lightning) {
            ...
            titleDiv.className = 'slds-form-element__label';
          }
          titleDiv.style =
          'padding: 0px;' +
          'text-align: left;' +
        ...
        if (!window.ran && location.href.indexOf('edit') > -1 && location.href.indexOf('gus.lightning.force') > -1) {
          console.log('edit lightning');
          var element = document.getElementById('bugEdit:j_id0:workSds:storyWorkForm:dstpInput:inputComponent:inputFieldWithContainer:textAreaDelegate_Details_And_Steps_To_Reproduce__c_rta_body') || document.getElementById('userStoryEdit:j_id0:workSds:storyWorkForm:descriptionInput:inputComponent:inputFieldWithContainer');
          function waitForElem() {
            if(element == null) {
              element = document.getElementById('bugEdit:j_id0:workSds:storyWorkForm:dstpInput:inputComponent:inputFieldWithContainer:textAreaDelegate_Details_And_Steps_To_Reproduce__c_rta_body') || document.getElementById('userStoryEdit:j_id0:workSds:storyWorkForm:descriptionInput:inputComponent:inputFieldWithContainer');
              console.log(element);
              setTimeout(waitForElem, 250);
            }
            else {
              console.log('here');
              var destinationElement = document.querySelector('.slds-form-element');
              editingPage(element, destinationElement, true);
            }
          }
          waitForElem();
          ...
          function waitForElem() {
            if(typeof element == 'undefined') {
              ...
              editingPage(element, destinationElement, false);
            }
          }
          waitForElem();
