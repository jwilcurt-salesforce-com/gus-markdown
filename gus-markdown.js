...
(function() {
    ...
    function viewingPage (descriptionBox) {
        ...
        if (descriptionBoxHTML.length > 0) {
            ...
            md = md.split('<br>').join('\n');
            md = md.replace(/\n\s?\d\)\s/g, '\n1. ');
            // console.log(descriptionBoxHTML);
    ...
    } else if (!window.ran && location.href.indexOf('bugdetail') > -1) {
